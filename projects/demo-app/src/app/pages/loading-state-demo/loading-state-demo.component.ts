...
import { LoadingStateComponent } from 'ng-daisy-ui-components';
    ...
    <div class="container mx-auto p-8">
      ...
      <div class="mb-8 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select [(ngModel)]="selectedType" class="select w-full">
        ...
        <div class="mt-4 flex flex-wrap gap-2">
          <button (click)="clearMessage()" class="btn btn-secondary">
            Clear Message
          </button>
          <button (click)="setRandomMessage()" class="btn btn-primary">
            Random Message
          </button>
      ...
      <div class="mt-8 p-4 bg-base-100">
        ...
        <div class="text-sm space-y-1">
          ...
          <p>
            <strong>Message:</strong> {{ customMessage || 'Default message' }}
          </p>
        </div>
      </div>
    </div>
