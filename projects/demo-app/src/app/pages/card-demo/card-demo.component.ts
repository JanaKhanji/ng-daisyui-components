...
import { CardComponent, ToastService } from 'ng-daisy-ui-components';
  ...
  template: `
    <div class="container mx-auto p-8">
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <ng-container content>
              <p>
                This card has an image and demonstrates the image functionality.
              </p>
            </ng-container>
          </ng-card>

          <!-- Card with Actions -->
          <ng-card title="Card with Actions" [actions]="true">
            <ng-container content>
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <ng-container content>
              <p>
                This card uses custom styling with different background and
                shadow.
              </p>
            </ng-container>
          </ng-card>
          ...
          <ng-card title="Card with Long Content" [actions]="true">
            <ng-container content>
              <p>
          ...
          <ng-card customClass="rounded-md bg-base-100">
            <ng-container content>
              <p>
                This is a minimal card with custom class and only content, no
                title or actions.
              </p>
            </ng-container>
          </ng-card>
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <!-- Interactive Card -->
          <ng-card title="Interactive Card" [actions]="true">
            <ng-container content>
              <p>
                This card demonstrates interactive features with multiple action
                buttons.
              </p>
            </ng-container>
            <ng-container actions>
          ...
          <!-- Card with Form -->
          <ng-card title="Card with Form" [actions]="true">
            <ng-container content>
          ...
          >
            <ng-container content>
              <p>
                This card shows different status states with appropriate
                styling.
              </p>
            </ng-container>
            <ng-container actions>
