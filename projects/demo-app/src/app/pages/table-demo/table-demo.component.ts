...
export class TableDemoComponent {
  ...
  users: User[] = [
    ...
    { id: 3, name: 'Bob Johnson', email: 'bob.johnson@example.com', role: 'Editor', status: 'inactive', joinDate: '2023-03-10' },
    { id: 4, name: 'Alice Brown', email: 'alice.brown@example.com', role: 'User', status: 'active', joinDate: '2023-04-05' },
    { id: 5, name: 'Charlie Wilson', email: 'charlie.wilson@example.com', role: 'Admin', status: 'active', joinDate: '2023-05-12' },
  ];
  ...
  onSortChange(columns: Column<User>[]) {
    ...
    this.toastService.showSuccess('Sort changed: ' + sortedColumn?.header + ' ' + sortedColumn?.sort);
  }
